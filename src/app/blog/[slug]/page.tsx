                    ...
                    (<section className="section-single-blog section-base-style">
                        <div className="section-single-blog-container container-base-style">
                            <div className="single-blog-content flex flex-col md:flex-row gap-4 lg:gap-6">
                                <div className="sinlge-blog-content-left flex flex-col flex-3 gap-4 md:gap-2">
                                    ...
                                    <div className="single-blog-content-left-title text-[1.3rem] md:text-[1.2rem] lg:text-[1.4rem] font-bold capitalize px-4 py-3 border-l-2 border-l-primary/50 bg-accent">
                                        {currentBlog.title}
                                    </div>
                                ...
                                <div className="single-blog-content-right flex flex-col flex-2 gap-6">
                                    ...
                                    <div className="single-blog-content-recommendation flex flex-col gap-8 md:gap-2">
