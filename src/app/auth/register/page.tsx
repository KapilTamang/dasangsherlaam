...
export default function Login() {
        return( 
            <main className="w-full min-h-screen pb-10 md:pb-0 bg-accent relative">
                ...
                fill
                preload/>
                <div className="register-page flex flex-col gap-6 md:gap-0">
                    ...
                    <div className="register-form static md:fixed md:top-[50%] md:left-[50%] md:translate-x-[-50%] md:translate-y-[-50%] w-full sm:w-140 px-6 md:px-0 mx-auto md:mx-0">
                        <RegisterForm/>
                    </div>
                </div>
            </main>
