...
export default function SocialShare({isLoading}: SocialShareProps) {
    return(
        <div className="social-share flex gap-2 bg-accent px-4 py-2 border-l border-l-primary cursor-pointer">
            {
                isLoading  ?
                (
                ...
                (
                    <>
                        <Share2 className="text-primary fill-transparent hover:fill-primary duration-300" size={20}/>
